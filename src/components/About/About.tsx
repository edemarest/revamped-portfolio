      ...
      <div className={styles.aboutIntroGrid}>
        <div className={styles.introCol}>
          ...
          <p className={styles.introBody}>
            I'm Ella! Though I've studied and worked all over the place the past few years, I'm originally from San Diego. Boston became my home during college, and a summer in New York at Regeneron gave me a taste of East Coast life, but I've been pulled back toward California -- I'm relocating to the SF Bay Area, drawn to the density of AI and creative tech happening there right now.<br /><br />
            ...
            I also spend a lot of time outside. I walk everywhere -- not just for the steps, but because I play Pokemon Go. It keeps me exploring new neighborhoods, and I've hit level 50 while joining a weekly Cambridge walking group. I take health and fitness seriously, working out six days a week, but balance it with my favorite ritual: trying a new dessert every Saturday. (Right now, edible cookie dough from Little Miss Cupcape is undefeated -- taking SF recommendations.)<br /><br />
            I'm happiest when I'm building -- projects, experiences, connections -- and finding little ways to make each week an adventure.
          </p>
        </div>
